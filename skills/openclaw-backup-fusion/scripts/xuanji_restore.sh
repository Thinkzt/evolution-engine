#!/usr/bin/env bash
# xuanji_restore.sh - 璇玑史OpenClaw恢复系统
# Usage: xuanji_restore.sh <backup.tar.gz> [--dry-run]
...
[ -d "${BACKUP_DIR}/config" ] && [ -f "${BACKUP_DIR}/config/openclaw.json" ] && \
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ 恢复完成!"
echo "请重启OpenClaw Gateway以加载新配置"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
